...
$subCategory = DB::table('users')->get();
            ...
            <div class="top-bar right">
                ...
                <ul class="horizontal-menu">
                    ...
                    <li>
                        ...
                        <i class="biolife-icon icon-login"></i> Sign Out</a>
                    </li>
                    @else
                            ...
                            <li class="menu-item menu-item-has-children has-child">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-has-children has-child"><a href="#" class="menu-name"
                                            data-title="Eggs & other considerations">Eggs & other considerations</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-has-children has-child"><a href="#" class="menu-name"
                                            data-title="Sides & Extras">Sides & Extras</a>
                                        <ul class="sub-menu">
                                            ...
                                            <div class="wrap-custom-menu vertical-menu">
                                                ...
                                                <ul class="menu">
                                                    <li class="menu-item"><a href="category-grid-3-cols.html">Grid 3
                                                            Cols</a></li>
                                                    <li class="menu-item"><a href="category-grid.html">Grid 4 Cols</a>
                                                    </li>
                                                    ...
                                                    <div class="left-info">
                                                        ...
                                                        <div class="qty">
                                                            ...
                                                            <input type="number" class="input-qty"
                                                                name="cart[id123][qty]" id="cart[id123][qty]" value="1"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="action">
                                                ...
                                                <div class="minicart-item">
                                                    ...
                                                    <div class="left-info">
                                                        ...
                                                        <div class="qty">
                                                            ...
                                                            <input type="number" class="input-qty"
                                                                name="cart[id124][qty]" id="cart[id124][qty]" value="1"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="action">
                                                ...
                                                <div class="minicart-item">
                                                    ...
                                                    <div class="left-info">
                                                        ...
                                                        <div class="qty">
                                                            ...
                                                            <input type="number" class="input-qty"
                                                                name="cart[id125][qty]" id="cart[id125][qty]" value="1"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="action">
                                                ...
                                                <div class="minicart-item">
                                                    ...
                                                    <div class="left-info">
                                                        ...
                                                        <div class="qty">
                                                            ...
                                                            <input type="number" class="input-qty"
                                                                name="cart[id126][qty]" id="cart[id126][qty]" value="1"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="action">
                                                ...
                                                <div class="minicart-item">
                                                    ...
                                                    <div class="left-info">
                                                        ...
                                                        <div class="qty">
                                                            ...
                                                            <input type="number" class="input-qty"
                                                                name="cart[id127][qty]" id="cart[id127][qty]" value="1"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="action">
